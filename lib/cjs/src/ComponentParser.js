...
const TestJavaStrings_1 = __importDefault(require("../devTesting/TestJavaStrings"));
...
class ComponentParser {
    ...
    parseTest(serviceName) {
        const cstNode = JP.parse(TestJavaStrings_1.default.LOGIN);
        ...
        queryTypeArr.forEach((queryType) => {
            ...
            if (!results[queryType])
                results[queryType] = [];
            results[queryType] = Object.assign({}, finalResults);
        });
